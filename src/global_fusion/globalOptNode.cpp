...
void vio_callback(const nav_msgs::Odometry::ConstPtr &pose_msg)
{
    ...
    Eigen::Matrix3d tmp_R = global_q.toRotationMatrix();

    std::ofstream foutC("/home/didula/GVLOAM/src/Results/GVLOAM.txt", ios::app);
...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber sub_GPS = n.subscribe("/fix", 100, GPS_callback); 	//D - Subscribe to GPS messages
    //ros::Subscriber sub_GPS = n.subscribe("/gps/fix", 100, GPS_callback);
    //ros::Subscriber sub_vio = n.subscribe("/vins_estimator/odometry", 100, vio_callback);
    ros::Subscriber sub_vio = n.subscribe("/aft_mapped_to_init_high_frec", 100, vio_callback);    //VI-LOAM 
